...
st.markdown("### Why this matters for Future Shivang")

st.markdown(
    """
Most of the time, my problem isn’t that I *don’t know* what to do.

It’s that in the actual moment – when I’m nervous, distracted, or rushing –
I default to **Past Me** patterns instead of what **Future Me** would choose.

This toolkit exists to shrink that gap.

- **Before the Moment** gives Future Me a tiny bit of advance warning.
  I can name what’s coming, notice my old pattern, and script one small, better move.

- **After the Moment** lets me replay what actually happened, honestly.
  I can see which version of me showed up, and whether that’s the pattern I want to keep.

Over time, these small reps are how influence changes from *“nice ideas from class”*
to **automatic habits** in real conversations, interviews, and conflicts.

This isn’t a dashboard for a grade.
It’s a little space I can come back to whenever I don’t want Past Me running the show.
"""
)

st.markdown(
    """
In my video, you’ll see **Past Me**, **Present Me**, and **Future Me** talk through real situations.
This site is the **artifact**.
The video is the **conversation** between those versions of me.

If Future Me comes back to this in a year, I want it to feel instantly familiar.
"""
)
